...
export interface SettingsDefaults {
  ...
  // Summary Behavior
  CLAUDE_MEM_ASYNC_SUMMARY: string;    // 'true' | 'false' - when 'true', Stop hook fires summary request and returns immediately without polling
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    // Summary Behavior
    CLAUDE_MEM_ASYNC_SUMMARY: 'false',  // When 'true', Stop hook queues summary and returns immediately without waiting
    // Chroma Vector Database Configuration
